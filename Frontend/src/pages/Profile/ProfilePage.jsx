...
const ProfilePage = () => {
  ...
  const date = parseISO(user?.createdAt || '2024-01-01');
  // Format the date to get the month name and year
  const memberSince = format(date, 'dd MMMM yyyy');
  ...
  return (
    <>
      {!loadingUserProfile && isError ? (
        <p className="flex-[4_4_0]  border-r border-gray-700 min-h-screen text-center p-4 text-3xl">
          User not found 😥
        </p>
      ) : (
        <div className="flex-[4_4_0]  border-r border-gray-700 min-h-screen ">
          ...
          <div className="flex flex-col" id="profile-page">
            {!loadingUserProfile && user && (
              <>
                ...
                <div className="flex justify-end px-4 mt-5 gap-2">
                  {isMyProfile && <EditProfileModal userProfile={authuser} />}
                  {!isMyProfile && (
                    <button
                ...
                <div className="flex flex-col gap-4 mt-14 px-4">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <span className="text-sm text-slate-500">Joined {memberSince}</span>
                    </div>
                  </div>
            ...
            <Posts userId={user?._id} feedType={feedType} username={username} setPost={setPost} />
          </div>
        </div>
      )}
    </>
